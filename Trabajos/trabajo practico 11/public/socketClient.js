...
socket.on("lastProducts", (data) => {
    const lastProducts = [data[data.length - 1], data[data.length - 2], data[data.length - 3]];
...
socket.on("chat", (data) => {
    const denormalizedData = denormalize(data.result, messageListSchema, data.entities);
